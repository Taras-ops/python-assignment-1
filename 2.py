...
def transform_temperatures():
    ...
    for i in range(7):
        temperature = input('Write the temperature in Fahrenheit degrees of the ' + str(i + 1) + ' day of the week: ')
        ...
        temperature_celsius = fahrenheit_to_celsius(int(temperature))
    ...
    print(f'Average temperature in Celsius degree: {average_temperature}')
    print(f'Max temperature in Celsius degree: {max_temperature}')
    print(f'Min temperature in Celsius degree: {min_temperature}')
